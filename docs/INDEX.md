...
| [THREAT_MODEL.md](THREAT_MODEL.md) | 1.5.0 | Security threats considered for the platform — organized into Closed Threats, Accepted Risk, and Open, Not Answered, each citing the ADR that resolved or owns it; includes Sprint 11's OWASP Top 10:2025 review and the ADR-029 waiter-GPM-classification open item, folded into this same structure. |
