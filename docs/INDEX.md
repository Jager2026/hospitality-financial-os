...
| [EVENT_CATALOG.md](EVENT_CATALOG.md) | 1.0.0 | The concrete catalog of `OutboxEvent` rows the codebase actually produces and their payload shapes, read directly from the code, not designed ahead of it. |
| [THREAT_MODEL.md](THREAT_MODEL.md) | 1.1.0 | Security threats considered for the platform — organized into Closed Threats, Accepted Risk, and Open, Not Answered, each citing the ADR that resolved or owns it. |
